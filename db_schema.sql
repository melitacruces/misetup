-- El esquema define las tablas e índices necesarios para MiSetup.
...
-- La inserción incorpora datos de demostración para el modo preview.
-- La condición evita duplicados al insertar datos solo en una base vacía.
DO $$
BEGIN
IF NOT EXISTS (SELECT 1 FROM equipment) THEN
PERFORM setval(pg_get_serial_sequence('equipment', 'id'), 1, false);
